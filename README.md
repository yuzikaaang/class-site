...
- 2026-08-26：隐藏娱乐天地再扩——新增 **中国象棋**（完整走法规则 + AI 三档 + 本地双人 + 悔棋）与 **飞机大战**（纵版射击）；**五子棋**升级（AI 三档：简单随机/普通贪心/困难深度搜索，可切换本地双人）；**扫雷**支持自定义雷数（简单10/中等24/困难60/自定义）。隐藏空间现共 **17 个入口**。公告新增模糊彩蛋提示（只说有隐藏空间，不透露入口与暗号）。
